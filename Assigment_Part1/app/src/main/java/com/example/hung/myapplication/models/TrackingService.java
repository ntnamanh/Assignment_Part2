...
import com.example.hung.myapplication.database.TrackingTable;
...
public class TrackingService
{
   ...
   public static class TrackingInfo
   {
      ...
      public ContentValues toValues() {
         ...
         values.put(TrackingTable.COLUMN_DATE, DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.MEDIUM).format(date));
         values.put(TrackingTable.COLUMN_TRACKABLE_ID,trackableId);
         values.put(TrackingTable.COLUMN_STOP_TIME,stopTime);
         values.put(TrackingTable.COLUMN_LATITUDE,latitude);
         values.put(TrackingTable.COLUMN_LONGITUDE,longitude);
         return values;
      }
   }
